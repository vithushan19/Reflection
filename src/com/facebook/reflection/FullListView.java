...
/**
 * A subclass of ListView that will always show the full list of elements. This
 * allows a ListView to be embedded inside a ScrollView.
 */
public class FullListView extends ListView {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		height += (count - 1) * getDividerHeight() + bgPadding.top
				+ bgPadding.bottom;
